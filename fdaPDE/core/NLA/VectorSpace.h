...
public:
  ...
  static DVector<double> projectOnto(const VectorSpace<N>& basis, const SVector<N>& x);
...
template <unsigned int N>
DVector<double> Geometry<N>::projectOnto(const VectorSpace<N>& spaceBasis, const SVector<N> &x){
