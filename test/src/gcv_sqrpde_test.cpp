...
//     EXPECT_TRUE(almost_equal(GCV.values(), "../data/gcv/sqrpde/2D_test1/gcvs.mtx"));
// }
...
//     EXPECT_TRUE(almost_equal(GCV.values(), "../data/gcv/sqrpde/2D_test2/gcvs.mtx"));
// }
...
//     EXPECT_TRUE(almost_equal(GCV.values(), "../data/gcv/sqrpde/2D_test3/gcvs.mtx"));
// }
...
//     EXPECT_TRUE(almost_equal(GCV.values(), "../data/gcv/sqrpde/2D_test4/gcvs.mtx"));
// }
...
//     EXPECT_TRUE(almost_equal(GCV.values(), "../data/gcv/sqrpde/2D_test5/gcvs.mtx"));
// }
...
//     EXPECT_TRUE(almost_equal(GCV.values(), "../data/gcv/sqrpde/2D_test6/gcvs.mtx"));
// }
...
//     EXPECT_TRUE(almost_equal(GCV.values(), "../data/gcv/sqrpde/2D_test7/gcvs.mtx"));
// }
...
//     EXPECT_TRUE(almost_equal(GCV.values(), "../data/gcv/sqrpde/2D_test8/gcvs.mtx"));
// }
...
TEST(gcv_sqrpde_test, laplacian_nonparametric_samplingatlocations){
